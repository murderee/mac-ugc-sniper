        ...
        def buy_item(item_id: int, price: int, user_id: int, creator_id: int,
            ...
            while True:
                 ...
                 if response.status_code == 429:
                    print(fore.YELLOW+ "Ratelimit encountered. Retrying purchase in 1 second...")
                    time.sleep(1)
                    continue
                 ...
                 try:
                   ...
                   print(fore.RED+ f"JSON decode error encountered: {e}. Retrying purchase...")
                   total_errors += 1
                   continue

                 if not json_response["purchased"]:
                    print(fore.RED+ f"Purchase failed. Response: {json_response}. Retrying purchase...")
                    total_errors += 1
                    time.sleep(0.5)
                 else:
                    print(fore.GREEN+ f"Purchase successful. Response: {json_response}.")
                    self.buys += 1
                    time.sleep(0.5)
        ...
        while True:
            ...
            for currentItem in self.items:
                ...
                if response.status_code != 200:
                    print(fore.YELLOW +"Rate limit hit")
